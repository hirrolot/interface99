...
#define Foo_INTERFACE(OP, CTX) OP(CTX, const char *, foo, int x, double *restrict y)

#define Bar_INTERFACE(OP, CTX)                                                                     \
    OP(CTX, const char *, foo, int x, double *restrict y)                                          \
    OP(CTX, float, bar, long long x)
